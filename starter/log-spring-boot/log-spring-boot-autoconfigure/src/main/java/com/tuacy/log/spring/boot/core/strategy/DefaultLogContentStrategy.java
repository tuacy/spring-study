 ...
 */
@Slf4j
public class DefaultLogContentStrategy extends LogContentStrategy {
     ...
     */
    @Override
    public String methodExecutionSuccess(LogAnnotation annotation, String successSpEl, ProceedingJoinPoint pjp, Object result) {
     ...
     */
    @Override
    public String methodExecutionError(LogAnnotation annotation, String errorSpEl, ProceedingJoinPoint pjp, Object result) {
        Method method = getMethod(pjp);
        Object[] args = pjp.getArgs();
        try {
     ...
     */
    @Override
    public String methodExecutionException(LogAnnotation annotation, String exceptionSpEl, ProceedingJoinPoint pjp, Exception ex) {
        Method method = getMethod(pjp);
        Object[] args = pjp.getArgs();
        try {
