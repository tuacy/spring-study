 ...
 * 业务日志，内容生成策略
 *
 * @name: BizLogContentStrategy
 * @author: tuacy.
 * @date: 2020/4/13.
 * @version: 1.0
 */
@Slf4j
public abstract class BizLogContentStrategy {
     ...
     * @return content
     */
    public abstract String methodExecutionSuccess(BizLogAnnotation annotation, String successSpEl, ProceedingJoinPoint pjp, Object result);
     ...
     * @return content
     */
    public abstract String methodExecutionError(BizLogAnnotation annotation, String errorSpEl, ProceedingJoinPoint pjp, Object result);
     ...
     * @return content
     */
    public abstract String methodExecutionException(BizLogAnnotation annotation, String exceptionSpEl, ProceedingJoinPoint pjp, Exception ex);
     ...
     */
    protected String expressionParser(BizLogAnnotation annotation, String el, Method method, Object[] args, Object result) {
        String[] params = discoverer.getParameterNames(method);
        EvaluationContext context = new StandardEvaluationContext();
        if (params != null) {
            for (int i = 0; i < params.length; i++) {
        ...
        // 错误信息描述
        if (annotation != null) {
            Class<? extends BizLogErrorMessageStrategy> errorMessageStrategyClass = annotation.errorMessageStrategy();
            try {
                BizLogErrorMessageStrategy errorMessageStrategy = errorMessageStrategyClass.newInstance();
